...
const FixedReturn = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        // Filter posts for Fixed Return category
  ...
  const getSectorCounts = () => {
    ...
    allSectors.forEach((sector) => {
      sectorCounts[sector] = fixedReturnpost.filter(
  ...
  const getDurationCounts = () => {
    ...
    allDurations.forEach((duration) => {
      durationCounts[duration] = fixedReturnpost.filter(
  ...
  const clearFilters = () => {
    setSelectedSector("");
    setSelectedDuration("");
    setFilteredPosts(fixedReturnpost);
  };
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content flex flex-col p-10">
          <div className="fixed top-[100px] left-[5px] z-40">
            <label
              htmlFor="my-drawer-2"
              className="btn bg-salmon text-white sm:mt-96 xs:mt-96 xxs:mt-96 lg:mt-0  sticky drawer-button transform transition-transform duration-300 ease-in-out delay-150 hover:scale-105"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:w-[1200px] lg:mx-auto sm:mx-auto lg:gap-12 xs:gap-8 xxs:gap-8 sm:gap-8 px-6 lg:px-20 cursor-pointer">
